    ...
    <?php if (empty($noticias)): ?>
        <div class="empty-state">
            ...
            <?php if (!usuario_logado()): ?>
                <a href="../public/cadastro.php" class="btn btn-primary mt-3">Criar Conta</a>
            <?php else: ?>
                <a href="../admin/nova_noticia.php" class="btn btn-primary mt-3">Nova Notícia</a>
            <?php endif; ?>
        </div>
    <?php else: ?>
    <div class="news-grid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="../public/noticia.php?id=<?= $n['id'] ?>" class="btn btn-primary btn-sm">▶ LER MAIS</a>
            </div>
        </div>
        <?php endforeach; ?>
    </div>
